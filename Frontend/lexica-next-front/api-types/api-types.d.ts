...
export interface paths {
    ...
    "/api/sets/proposed-name": {
        ...
        /** Return the next proposed set name in format set_XXXX */
        get: operations["GetProposedSetName"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/words-statistics": {
        ...
        /** Return per-word statistics for the current user's open-questions answers */
        get: operations["GetWordsStatistics"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        GetWordsStatisticsResponse: {
            /** Format: int32 */
            count?: number | string;
            data?: components["schemas"]["WordStatisticsRecordDto"][];
        };
        ProblemDetails: {
            type?: null | string;
            title?: null | string;
...
export interface operations {
    ...
    DeleteSets: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DeleteSetsRequest"];
            };
        };
        responses: {
    ...
    GetProposedSetName: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GetProposedSetNameResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    GetWordsStatistics: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GetWordsStatisticsResponse"];
                };
            };
            /** @description Bad Request */
            400: {

...
// Sort by createdAt ascending with CET timezone. Expected: 200 OK with timezone-converted dates.
                ...
                Db = new DbTestCaseData
                {
                    ...
                    [
                        new WordEntity
                        {
                            ...
                            CreatedAt = new DateTimeOffset(2025, 3, 10, 22, 0, 0, TimeSpan.Zero)
                        },
                        new WordEntity
                        {
                            WordId = Guid.NewGuid(), UserId = "test-user-id", Word = "second", WordTypeId = NounTypeId,
                            CreatedAt = new DateTimeOffset(2025, 3, 11, 10, 0, 0, TimeSpan.Zero)
                        },
                        new WordEntity
                        {
                            WordId = Guid.NewGuid(), UserId = "test-user-id", Word = "third", WordTypeId = NounTypeId,
                            CreatedAt = new DateTimeOffset(2025, 3, 12, 10, 0, 0, TimeSpan.Zero)
                        }
                    ]
                }
            }

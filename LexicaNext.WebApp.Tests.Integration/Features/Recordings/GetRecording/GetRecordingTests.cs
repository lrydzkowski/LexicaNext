...
public class GetRecordingTests
{
    ...
    {
        await using TestContextScope contextScope = new(_webApiFactory, _logMessages, _wireMockServer);
        ...
        return new GetRecordingTestResult
        {
            ...
            RecordingStorageCalls = contextScope.RecordingStorage!.Mock.GetReceivedMethodCalls(),
